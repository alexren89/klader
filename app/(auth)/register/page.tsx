...
const STRENGTH_COLORS = ["", "#D74B36", "#FF7E6B", "#8757B2", "#5C2E8E"];
          ...
          {success ? (
            <div className="text-center py-6">
              <div className="flex h-14 w-14 items-center justify-center rounded-full mx-auto mb-4"
                ...
                <Check className="h-7 w-7" style={{ color: "var(--brand-primary)" }} />
              </div>
              <h2 className="font-semibold mb-2" style={{ color: "var(--text-primary)" }}>¡Cuenta creada!</h2>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {[
                  { label: "Nombre", key: "name", type: "text", placeholder: "Tu nombre", min: 2 },
                    ...
                    <div className="mt-1.5 flex gap-1">
                      {[1, 2, 3, 4].map(i => (
                        <div
                          ...
                          style={{ background: i <= strength ? STRENGTH_COLORS[strength] : "var(--border-subtle)" }}
                        />
                      ))}
                    </div>
                  )}
